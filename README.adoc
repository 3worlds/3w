...
- Gignoux J., I.D. Davies, & S.R. Flint (2022). 3worlds: a software for ecosystem simulation, version 1.0.3, https://zenodo.org/record/7038145[DOI:10.5281/zenodo.7038145] for the software itself.
